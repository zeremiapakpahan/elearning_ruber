        ...
        <div class="kelas-main-content">
            <div class="qe-result">
                <div class="grade-section">
                    @if (Request::is('guru/kelas/hasil-quiz-essay*'))
                        <h3>PROSES PENILAIAN HASIL QUIZ ESSAY SISWA</h3>
                        <div class="grade-row">
                            ...
                            <span class="grade">
                                ...
                                <span>
                                    @if ($proses->hasilQuizEssay != '')
                                        ...
                                        <p onclick="window.location.href='{{ url('guru/kelas/edit-penilaian-quiz-essay/'.$proses->hasilQuizEssay->id) }}'"><i class="fa fa-pen"></i> Edit</p>
                                    @endif
                                </span>
                            </span>
                ...
                <div class="qe-preview-section">
                    ...
                    @if (Request::is('guru/kelas/hasil-quiz-essay*'))
                        {!! Form::model($objek, ['action' => $action, 'method' => $method]) !!}
                            {!! Form::hidden('proses_quiz_essay_id', $proses->id) !!}
                            ...
                            @foreach ($quiz->quizEssay as $qe)
                                <div class="question-row">
                                    ...
                                    <span class="answer">
                                        <span>
                                            {{ $qe->prosesQuizEssay->where('siswa_id', $proses->siswa->id)->first()->jawaban }}
                                        </span>
                                    ...
                                    <span class="point" > 
                                        <span class="grade">
                                            @if ($proses->hasilQuizEssay == '')
                                                ...
                                                <input class="input-section" type="text" name="nilai[]" value="">
                                            @else
                                                <span class="tag">Point <p>:</p></span>
                                                <span>{{ $qe->prosesQuizEssay->where('siswa_id', $proses->siswa->id)->first()->nilai }}</span>
                                            @endif
                                        </span>
                                        <input class="input-section" type="text" placeholder="Point" value="{{ $qe->point }}">
                                    </span>
                                </div>
                            @endforeach
                    ...
                    @if (Request::is('guru/kelas/edit-penilaian-quiz-essay*'))
                        {!! Form::model($objek, ['action' => $action, 'method' => $method]) !!}
                            {!! Form::hidden('proses_quiz_essay_id', $proses->id) !!}
                            ...
                            @foreach ($quiz->quizEssay as $qe)
                                <div class="question-row">
                                    ...
                                    <span class="answer">
                                        ...
                                        <span class="check-point">
                                                @if ($qe->prosesQuizEssay->where('siswa_id', $proses->siswa->id)->first()->nilai != 0 )
                                    ...
                                    <span class="point" > 
                                        <span class="grade">
                                            <span class="tag">Point <p>:</p></span>
                                            <input class="input-section" type="text" name="nilai[]" value="{{ $qe->prosesQuizEssay->where('siswa_id', $proses->siswa->id)->first()->nilai }}">
                                        </span>
                                        <input class="input-section" type="text" placeholder="Point" value="{{ $qe->point }}">
                                    </span>
                                </div>
