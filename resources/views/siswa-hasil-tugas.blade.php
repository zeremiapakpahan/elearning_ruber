        ...
        <div class="kelas-main-content">
            <div class="submission-grade">
                <div class="grade-section">
                    @if (Request::is('siswa/kelas/hasil-tugas*'))
                            ...
                            <div class="submission-file">
                                ...
                                <div>
                                    @foreach ($proses_tugas->fileProsesTugas as $files)
                                        <a id="file-link" href="{{ \Storage::url($files->file) }}"><span id="file-image-container"></span> <span>{{ $files->file }}</span> </a>
                                    @endforeach
                                </div>
                            </div>
                            <span class="grade">
                                ...
                                @if ($proses_tugas->hasilTugas != '')
                                    <span>{{ $proses_tugas->hasilTugas->nilai  }}</span>
                                @else
                ...
                @if ($proses_tugas->hasilTugas != '')
                    <div class="comment-section">
                            ...
                            @foreach ($komen_siswa as $komen)
                                ...
                                <div class="comment-row" data-datetime="{{ $komen->created_at->format('d M Y H:i:s') }}" id="guru-section">
                                    <div class="comment-header">
                                        ...
                                        <span  onclick="window.location.href='{{ url('siswa/kelas/edit-komentar-hasil-tugas/'.$komen->id) }}'"><i class="fa fa-pen"></i> Edit </span>
                                        <span  onclick="window.location.href='{{ url('siswa/kelas/hapus-komentar-hasil-tugas/'.$komen->id) }}'"><i class="fa fa-trash"></i> Hapus </span>
                                    </div>
                                    <div class="comment-content">
                                        {{ $komen->isi }}
                        ...
                        @if (Request::is('siswa/kelas/edit-komentar-hasil-tugas*'))
                            {{-- <form class="comment-form" action=""> --}}
                            {!! Form::model($objek, ['action' => $action, 'method' => $method, 'files' => true, 'class' => 'comment-form' ]) !!}
