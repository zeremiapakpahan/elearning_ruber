        ...
        <div class="kelas-main-content">
            <div class="member">
                <div class="member-list-section">
                    ...
                    @foreach ($siswa_lain as $siswa_lain)
                        <div class="member-list-row">
                            <div class="member-photo">
                                @if ($siswa_lain->siswa->foto != '')
                                    <img src="{{ \Storage::url($siswa_lain->siswa->foto) }}" alt="Foto">
                                @else
                                    <img src="{{ asset('project') }}/img/avatar.jpg" alt="Foto">
                                @endif
                            </div>
                            <div class="member-identity" id="guru-section">
                                <span>{{ $siswa_lain->siswa->nama }}</span>
                                <span>{{ $siswa_lain->siswa->email }}</span>
                                <span>{{ $siswa_lain->siswa->status }}</span>
                            </div>
                        </div>
                    @endforeach
                    <div class="member-list-row">
                        <div class="member-photo">
                            @if ($pribadi->siswa->foto != '')
                                <img src="{{ \Storage::url($pribadi->siswa->foto) }}" alt="Foto">
                            @else
                                <img src="{{ asset('project') }}/img/avatar.jpg" alt="Foto">
                            @endif
                        </div>
                        <div class="member-identity" id="siswa-section">
                            <span>{{ $pribadi->siswa->nama }}</span>
                            <span>{{ $pribadi->siswa->email }}</span>
                            <span>{{ $pribadi->siswa->status }}</span>
                        </div>
                        <span onclick="window.location.href='{{ url('siswa/kelas/keluar-kelas/'.$pribadi->id) }}'" class="m-delete" id="siswa-section"> <i class="fa fa-sign-out-alt"></i> Keluar </span>
                    </div>
                </div>
            </div>
        </div>
