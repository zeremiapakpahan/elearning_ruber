...
<body>
    ...
    <div class="content">
        ...
        <div class="table-container">
            ...
            <h5>Matematika</h5>
            <table class="teacher-list" id="admin">
                    ...
                    @foreach ($kelas_mtk as $kelas)
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="window.location.href='{{ url('admin/data-guru/hapus/'.$kelas->guru->id) }}'" type="button" class="btn-section">Hapus</button>
                            </td>
                        </tr>
                                    ...
                                    <div class="dropdown-list">
                                        ...
                                        <div class="teacher-profil">
                                            ...
                                            <div class="profil-content">
                                                @if ($kelas->guru->foto != '')
                                                    <img src="{{ \Storage::url($kelas->guru->foto) }}" alt="Foto">
                                                @else
                                                    <img src="{{ asset('project') }}/img/avatar.jpg" alt="Foto">
                                                @endif
                                                <div class="text-data-section">
                                                    <span>{{ $kelas->guru->nama }}</span>
                                                    <span>{{ $kelas->guru->email }}</span>
                                                    <span>{{ $kelas->guru->status }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="teacher-class">
                                            <span>Kelas Guru</span>
                                            @foreach ($kelas->guru->kelas as $kelas_guru)
                                            <div class="class-content">
                                                <img src="{{ asset('project') }}/img/pattern.png" alt="Pattern">
                                                <div class="text-data-section">
                                                    <span>{{ $kelas_guru->nama_kelas }}</span>
                                                    <span>{{ $kelas_guru->deskripsi }}</span>
                                                </div>
                                            </div>
                                            @endforeach
                                        </div>
