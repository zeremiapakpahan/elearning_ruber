    ...
    <div class="content">
        ...
        <div class="daftar-kelas">
            ...
            @foreach ($kelas as $kelas)
                <a href="{{ url('guru/kelas/index/'.$kelas->id) }}">
                    <div class="kelas-row">
                        ...
                        <div class="kelas-desk">
                            ...
                            <span>{{ $kelas->created_at->format('d-m-Y') }}</span>
                        </div>
                    </div>
                </a>
            @endforeach
        ...
        <div class="form-wrapper">
            ...
            {!! Form::model($objek, ['action' => $action, 'method' => $method, 'class' => 'form-kelas']) !!}
                <div class="input-container">
                    <input name="nama_kelas" class="input" maxlength="70" type="text">
                    <span></span>
                    <label class="label" for="nama_kelas">Nama Kelas</label>
                </div>

                <div class="input-container">
                    <input name="deskripsi" class="input" type="text">
                    <span></span>
                    <label class="label" for="deskripsi">Deskripsi</label>
                </div>

                <div class="input-container">
                    <input name="kode_kelas" class="input" maxlength="6" type="text" value="{{ $objek->kode_kelas ?? \Str::random(6) }}">
                    <span></span>
