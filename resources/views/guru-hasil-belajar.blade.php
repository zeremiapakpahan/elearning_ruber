            ...
            @foreach ($kelas as $kelas)
                ...
                <table class="student-list">
                    ...
                    <tbody class="list-content">
                        @foreach ($kelas->anggota->where('guru_id', 0) as $anggota)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $anggota->siswa->nama  }}</td>
                                <td><button onclick="window.location.href='{{ url('guru/hasil-belajar-siswa/detail/'.$anggota->id) }}'" type="button" class="btn-section">Hasil</button></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
