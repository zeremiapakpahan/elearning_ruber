    ...
    <div class="profil">
        <div class="profil-image">
            @if (\Auth::guard('siswa')->user()->foto != '')
                <img src="{{ \Storage::url(\Auth::guard('siswa')->user()->foto) }}" alt="Profil" id="profil-img">
            @else
        ...
        <div class="bio">
            <span class="nama-lengkap">{{ \Auth::guard('siswa')->user()->nama }}</span>
            <span>{{ \Auth::guard('siswa')->user()->email }}</span>
            <span>{{ \Auth::guard('siswa')->user()->status }}</span>
        </div>
