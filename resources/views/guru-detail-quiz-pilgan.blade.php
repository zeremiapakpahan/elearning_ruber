...
<body>
    ...
    <div class="content">
        ...
        <div class="kelas-main-content">
            <div class="quiz-pilgan-detail">
                <div class="quiz-pilgan-nav">
                    <span class="active">Submission</span>
                    <span>Quiz Preview</span>
                </div>
                <div class="submission-section">
                    <span class="submission-total">
                        Yang Mengerjakan: <p>{{ count($proses) }}</p>
                    </span>
                    @foreach ($proses as $proses)
                        <div class="submission-row" data-datetime_sm="{{ $proses->created_at->format('d M Y H:i:s') }}">
                            <div class="submission-header">
                                @if ($proses->siswa->foto != '')
                                    <img src="{{ \Storage::url($proses->siswa->foto) }}" alt="Foto">
                                @else
                                    <img src="{{ asset('project') }}/img/avatar.jpg" alt="Foto">
                                @endif
                                <span class="submission-identity">
                                    <span>{{ $proses->siswa->nama }}</span>
                                    <span>{{ $proses->siswa->status }}</span>
                                </span>
                            </div>
                            
                            <span class="process-btn">
                                <button onclick="window.location.href='{{ url('guru/kelas/hasil-quiz-pilgan/'.$proses->id) }}'" type="button" class="btn-section">Hasil</button>
                            </span>
                            <span class="submission-datetime">
                                {{ $proses->created_at->format('d M Y H:i') }}
                            </span>
                        </div>
                    @endforeach
                </div>
                <div class="qp-preview-section">
                    <h3>QUIZ PILGAN PREVIEW</h3>
                    @foreach ($quiz->quizPilgan as $qp)
                        <div class="question-row">
                            ...
                            <span class="choice">
                                ...
                                <span><input name="pilihan" type="checkbox" value="{{ $qp->jawabanBenar->pilihan }}"></span>
                            ...
                            <span class="q-notice">
                                ...
                                <span>Point: {{ $qp->jawabanBenar->point }}</span>
                            </span>
                        </div>
                    @endforeach
                </div>
