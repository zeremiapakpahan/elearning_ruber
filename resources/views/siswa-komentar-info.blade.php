        ...
        <div class="kelas-main-content">
            <div class="information-comment">
                <div class="comment-section">
                    ...
                    @if (Request::is('siswa/kelas/komentar-informasi*'))
                        ...
                        @foreach ($komen_pribadi as $komen)
                            ...
                            <div class="comment-row" data-datetime="{{ $komen->created_at->format('d M Y H:i:s') }}" id="guru-section">
                                <div class="comment-header">
                                    ...
                                    <span onclick="window.location.href='{{ url('siswa/kelas/edit-komentar-info/'.$komen->id) }}'"><i class="fa fa-pen"></i> Edit </span>
                                    <span onclick="window.location.href='{{ url('siswa/kelas/hapus-komentar-info/'.$komen->id) }}'"><i class="fa fa-trash"></i> Hapus </span>
                                </div>
                                <div class="comment-content">
                                    {{ $komen->isi }}
                    ...
                    @if (Request::is('siswa/kelas/edit-komentar-info*'))
                        {{-- <form class="comment-form" action=""> --}}
                            {!! Form::model($objek, ['action' => $action, 'method' => $method, 'files' => true, 'class' => 'comment-form']) !!}
                            {!! Form::hidden('info_id', $info->id) !!}
