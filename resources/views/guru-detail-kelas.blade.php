            ...
            <div class="class-detail">
                <div class="cd-section">
                    ...
                    <div class="cd-content">
                        ...
                        <div class="right-cd-row">
                            <div class="detail-group">
                                <span class="name">
                                    <span>Nama Kelas <p>:</p></span>
                                    <span>{{ $kelas->nama_kelas }}</span>
                                    <span id="cd-edit"><i class="fa fa-pen"></i> Edit </span>
                                </span>
                                <span class="desc">
                                    <span>Deskripsi <p>:</p></span>
                                    <span>{{ $kelas->deskripsi }}</span>
                                </span>
                                <span class="code">
                                    <span>Kode Kelas <p>:</p></span>
                                    <span>{{ $kelas->kode_kelas }}</span>
                                </span>
                            </div>
                            {{-- <form class="cd-form" action=""> --}}
                            {!! Form::model($objek, ['action' => $action, 'method' => $method, 'class' => 'cd-form']) !!}
                                <input class="input-section" name="nama_kelas" type="text" value="{{ $objek->nama_kelas }}" placeholder="Nama Kelas">
                                <input class="input-section" name="deskripsi" type="text" value="{{ $objek->deskripsi }}" placeholder="Deskripsi">
                                <input class="input-section" name="kode_kelas" type="text" value="{{ $objek->kode_kelas }}" placeholder="Kode Kelas">
                                <button type="submit" class="btn-section">Kirim</button>
                            {!! Form::close() !!}
                            {{-- </form> --}}
                        </div>
                        <div class="bottom-cd-row">
                            <span class="post-total">
                                <span><i class="fa fa-copy"></i></span>
                                <div>
                                    <span>Kiriman</span>
                                    <span>{{ count($kelas->informasi) + count($kelas->penugasan) + count($kelas->quiz) }}</span>
                                </div>
                            </span>
                            <span class="attendance-total">
                                ...
                                <div>
                                    <span>Pertemuan</span>
                                    <span>{{ count($kelas->pertemuan) }}</span>
                                </div>
                            </span>
