...
<body>
    ...
    <div class="content">
        ...
        <div class="kelas-main-content">
            <div class="quiz-essay-detail">
                <div class="quiz-essay-nav">
                    ...
                    @foreach ($proses as $proses)
                        <div class="submission-row" data-datetime_sm="{{ $proses->created_at->format('d M Y H:i:s') }}">
                            ...
                            <span class="process-btn">
                                <button onclick="window.location.href='{{ url('guru/kelas/hasil-quiz-essay/'.$proses->id) }}'" type="button" class="btn-section">Proses</button>
                            </span>
                        ...
                        <div class="question-row">
                            ...
                            <span class="answer">
                                ...
                                <!-- <span class="check-point">
                                    <input name="nilai" type="checkbox" value="">
                                    <span></span>
                                </span> -->
                            </span>
                            <span class="point" > 
                                ...
                                <!-- <input class="input-section" name="point" type="text" placeholder="Point" value="25"> -->
                            </span>
                        </div>
                    @endforeach
                </div>
